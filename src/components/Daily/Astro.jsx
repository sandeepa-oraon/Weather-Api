...
function Astro({forecastData, hourData}) {
    return (
        <>
            <div className="sunmoon " style={{width:'95%'}}>
                <div className="today">
                        ...
                        <div className="rise-set">
                            <div className="sun">
                                <div className="riseSet">
                                    ...
                                    <p className="p1">{hourData.astro.sunrise}</p>
                                </div>
                                <div className="riseSet">
                                    <p className="p2" style={{ color: '#c5c6c7ab' }}>Set</p>
                                    <p className="p2">{hourData.astro.sunset}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="moonset">
                        <div className="moon">
                            ...
                            <div className="">{hourData.astro.moon_phase}</div>
                        </div>
                        <div className="rise-set">
                            <div className="sun">
                                <div className="riseSet">
                                    <p className="p1" style={{ color: '#c5c6c7ab' }}>Rise</p>
                                    <p className="p1">{hourData.astro.moonrise}</p>
                                </div>
                                <div className="riseSet">
                                    <p className="p2" style={{ color: '#c5c6c7ab' }}>Set</p>
                                    <p className="p2">{hourData.astro.moonset}</p>
                                </div>
                            </div>
                        </div>
                    </div>
