				...
				<div className="temperature box">
					...
					{/* <div className="temp2">
						<div className="celcius" >
							...
							<p className="">{forecastData.current.temp_c}°C</p>
						</div>
						<div className="farenheit">
							<p className="p3">in fahrenheit</p>
							<p className="">{forecastData.current.temp_f}°F</p>
						</div>
					</div> */}
					<div className="temp3">
						<div className="temp3_" style={{display:'flex', justifyContent:'space-between', padding:'5px 10px'}}>
							...
							<div className="temp3-">
								<p className="">{forecastData.forecast.forecastday[0].day.mintemp_c}°C</p>
								<p className="">{forecastData.forecast.forecastday[0].day.mintemp_f}°F</p>
							</div>
						</div>
						<div className=" temp3_" style={{display:'flex', justifyContent:'space-between', padding:'5px 10px'}}>
							<h5 style={{color:'#c5c6c7ab'}}>Average temperature</h5>
							<div className="temp3-">
								<p className="">{forecastData.forecast.forecastday[0].day.avgtemp_c}°C</p>
								<p className="">{forecastData.forecast.forecastday[0].day.avgtemp_f}°F</p>
							</div>
						</div>
						<div className="temp3_" style={{display:'flex', justifyContent:'space-between', padding:'5px 10px'}}>
							<h5 style={{color:'#c5c6c7ab'}}>Maximum temperature</h5>
							<div className="temp3-">
								<p className="">{forecastData.forecast.forecastday[0].day.maxtemp_c}°C</p>
								<p className="">{forecastData.forecast.forecastday[0].day.maxtemp_f}°F</p>
							</div>
						</div>
					</div>
				</div>
